...
function plotTrackMontageMultiples(curTrackNb, track, trackStack, varargin)
...
% scrHeight = scrsz(4);
% hf = figure('Visible', 'off', 'PaperPositionMode', 'auto', 'Position', [50, scrHeight-(curTrackNb-1)*height, width, height], 'Color', 'w');
